...
DEPT_INFO = {
    ...
    'Cardiology': {
        ...
        'desc':'specialises in heart cardiovascular conditions',
    ...
    'General Medicine': {
        ...
        'desc':'handles general health conserns ans non-specialist condition',
    ...
    'Dermatology': {
        ...
        'desc':'specialises in skin,hsir, and nail conditions',
...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#f8d2d2 0%,#f9ddda 60%,#f5d2c6 100%);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#ffecec;border:1px solid #f5f9d3;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#cdeef9;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#f9d6d6;border:1px solid #fbffd4;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#ddffd9;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">2</span>
            <span style="font-size:16px;font-weight:600;color:#d6e4ff;">how 
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#f0d6d6;border:1px solid #f1f2e5;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#d4ffcf;color:rgb(219, 191, 191);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">3</span>
            <span style="font-size:16px;font-weight:600;color:#cedefe;">how would you rate this Severity</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#e8d0d0;border:1px solid #dabdb6;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#dfefdd;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">4</span>
            <span style="font-size:16px;font-weight:600;color:#ccd9f3;">do you have any of the following</span>
        </div>
    </div>
    """, unsafe_allow_html=True)

    ch1, ch2, ch3, _ = st.columns(4)
    with ch1: hypertension  = st.checkbox("🩺 hypertension")
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#ffecec;border:1px solid #f6facb;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#dffedb;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#c6d2ec;">patient information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    submitted = st.form_submit_button("get AI reccomendation →")
...
if submitted:
    ...
    st.markdown("---")
    st.markdown("""
    <div style="font-size:22px;font-weight:700;color:#d6dce9;margin-bottom:4px;">AI reccomendation</div>
    ...
    with prob_col:
        ...
        st.markdown(bars_html + """
            ...
            <div style="margin-top:20px;background:#e90ee9;border:1px solid #ff0505;
                ...
                <strong>Model:</strong>KNN(K=7) . 102.000 patients . 99.5% accurancy<br>
