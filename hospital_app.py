...
with st.form("triage_form"):
    ...
    <div style="background:#f0d6d6;border:1px solid #f1f2e5;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#105efa;">how would you rate this Severity</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#ffecec;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#25f20a;color:white;border-radius:8px;
